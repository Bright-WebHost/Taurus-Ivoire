...
<li><a href={'mailto:ali@taurusivoire.com'} className="fa fa-envelope" /></li>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="mt-footer-bot-center">
                                   <a href='https://www.instagram.com/brightmedia.tech/'><span className="copyrights-text">© 2024 Taurus Ivoire {copyright} Bright Media</span></a> 
                                </div>
                            </div>
                        </div>
                    </div>
